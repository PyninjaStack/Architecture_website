...
<body>
  <div class="dashboard-container">
    <h2>Welcome, <?= htmlspecialchars($_SESSION['full_name']) ?> (Administrator)</h2>
        ...
        <?php if (count($projects) > 0): ?>
          <?php foreach ($projects as $p): ?>
            ...
            <tr>
              ...
              <!-- Actions -->
              <td>
                <?php if ($state === 'editor_approved'): ?>
                  <a href="../actions/update_state.php?id=<?= $p['id'] ?>&state=approved">Approve</a> |
                  <a href="../actions/update_state.php?id=<?= $p['id'] ?>&state=changes_requested_by_admin">Request Changes</a>
                <?php else: ?>
                  <em>Waiting</em>
                <?php endif; ?>
              </td>
